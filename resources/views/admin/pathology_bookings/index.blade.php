...
@section('title', 'Pathology Bookings')
@section('page-title', 'Pathology Bookings')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="mb-0">Pathology Bookings</h2>
    <button type="button" class="btn btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#adminBookModal">
        <i class="fa fa-plus me-1"></i> Book Pathology Test
    </button>
</div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="adminBookModalLabel"><i class="fa fa-vial me-2"></i> Book Walk-In Pathology Test</h5>
            ...
            <div class="modal-body text-start">
                <form id="adminBookForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Collection Type <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12">
                            <label class="form-label fw-semibold">Home Address (Required if Home Collection)</label>
                        ...
                        <!-- Tests -->
                        <div class="col-12">
                            <label class="form-label fw-semibold">Select Pathology Tests <span class="text-danger">*</span></label>
                            <select name="diagnostic_ids[]" id="select_tests" class="form-select select2-modal" multiple required data-placeholder="Select one or more pathology tests">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="remarks" class="form-control" rows="2" placeholder="Clinical notes or pathology instructions"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary" id="submit_booking_btn">
                            <i class="fa fa-check me-1"></i> Book Pathology Test
                        </button>
                    </div>
                </form>
            </div>
...
$(document).ready(function() {
    var table = $('#bookings_table').DataTable({
        ...
        "order": [[0, "desc"]],
        "ajax": {
            "url": "{{ route('admin.pathology-bookings.data') }}",
            "type": "GET",
    ...
    $('#adminBookForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.pathology-bookings.store') }}",
            type: "POST",
            data: $(this).serialize(),
            success: function(res) {
                $btn.prop('disabled', false).html('<i class="fa fa-check me-1"></i> Book Pathology Test');
