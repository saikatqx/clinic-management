...
@section('title', 'Booking Details - ' . $booking->booking_no)
@section('page-title', 'Booking Details')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="mb-0">Booking #{{ $booking->booking_no }}</h2>
    <a href="{{ route('admin.diagnostic-bookings.index') }}" class="btn btn-secondary shadow-sm">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 text-primary"><i class="fas fa-microscope me-2"></i> Booked Diagnostic Tests</h5>
            </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 text-primary"><i class="fas fa-file-pdf me-2"></i> Diagnostic Report PDF</h5>
            </div>
            <div class="card-body">
                @if($booking->report_pdf_path)
                    ...
                    <a href="{{ asset('reports/diagnostic/' . $booking->report_pdf_path) }}" target="_blank" class="btn btn-outline-success w-100 mb-3">
                ...
                <form action="{{ route('admin.diagnostic-bookings.uploadReport') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $booking->id }}">
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    $('#statusUpdateForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.diagnostic-bookings.updateStatus') }}",
            type: "POST",
            data: $(this).serialize(),
    ...
    $('#rescheduleForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('admin.diagnostic-bookings.reschedule') }}",
            type: "POST",
            data: $(this).serialize(),
            success: function(res) {
