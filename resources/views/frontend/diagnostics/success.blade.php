...
@section('title', 'Lab Booking Confirmed')
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card shadow border-0 p-5 rounded-4">
                    ...
                    <h2 class="fw-bold mb-3 text-success">Lab Booking Confirmed!</h2>
                    <p class="text-muted fs-5">Thank you, {{ $booking->patient_name }}. Your diagnostic lab booking request has been submitted successfully.</p>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <a href="{{ route('diagnostics.index.public') }}" class="btn btn-primary px-4 py-2">
                            🔬 Book More Tests
                        </a>
                    </div>
                </div>
