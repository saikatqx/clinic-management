...
@section('title', 'Complete Diagnostic Booking')
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('diagnostics.store.public') }}" method="POST" id="bookingForm" onsubmit="return validateBookingForm()">
                            @csrf
                            
                            <div class="row g-3">
                                <!-- Selected tests display -->
                                <div class="col-12 mb-3">
                                    <h5 class="fw-bold mb-3 text-secondary">Summary of Selected Tests</h5>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('diagnostics.index.public') }}" class="btn btn-secondary py-2 px-4">
                                    ⬅ Back to List
                                </a>
...
function validateBookingForm() {
    ...
    // Clear cart LocalStorage if form is valid and being submitted
    if (isValid) {
        localStorage.removeItem('diag_cart');
    }
