...
@section('title', 'Pathology Lab Tests')

@section('content')
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h1 class="fw-bold text-primary"><i class="fa fa-vials me-2"></i> Book Pathology Lab Tests</h1>
            <p class="text-muted">Select blood, urine, or other lab culture tests, add them to your cart, and book free home sample collection or clinic visit.</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0 p-3 mb-4">
                    <form action="{{ route('pathology.index.public') }}" method="GET" class="row g-2">
                        <div class="col-md-5">
                            <input type="text" name="search" class="form-control" placeholder="Search pathology tests..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-5">
                    ...
                    @empty
                        <div class="col-12">
                            <div class="card p-5 text-center text-muted border-0 shadow-sm">
                                ...
                                <h5>No pathology tests found.</h5>
                                <p class="small">Try adjusting filters or searching for other blood/urine tests.</p>
                            </div>
                        </div>
                    @endforelse
                </div>
                ...
                <div class="card shadow-sm border-0 sticky-top" style="top: 90px; z-index: 100;">
                    ...
                    <div class="card-body p-3">
                        <div id="cart_empty_state" class="text-center py-5 text-muted">
                            ...
                            <p class="mb-0">No pathology tests selected.</p>
                            <small class="d-block mt-1">Select pathology tests from the catalog to book your lab appointment.</small>
                        </div>
                        ...
                        <div id="cart_items_wrapper" class="d-none">
                            ...
                            <form action="{{ route('pathology.book.public') }}" method="POST">
                                @csrf
...
$(document).ready(function() {
    ...
    // Load from LocalStorage (separate pathology cart)
    if (localStorage.getItem('pathology_cart')) {
        try {
            cart = JSON.parse(localStorage.getItem('pathology_cart'));
            updateCartUI();
        } catch(e) {
            cart = [];
        }
    ...
    $(document).on('click', '.add-to-cart-btn', function() {
        ...
        localStorage.setItem('pathology_cart', JSON.stringify(cart));
        updateCartUI();
                ...
                $list.append(`
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <button type="button" class="btn btn-link text-danger p-0 remove-cart-item" data-id="${item.id}">
