...
@section('title', 'Health Package Booking Confirmed')
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card shadow border-0 p-5 rounded-4">
                    ...
                    <h2 class="fw-bold mb-3 text-success">Health Package Booked!</h2>
                    <p class="text-muted fs-5">Thank you, {{ $booking->patient_name }}. Your preventive health package checkup request has been submitted successfully.</p>
                    ...
                    <div class="p-4 bg-light rounded-3 border text-start my-4">
                        <div class="row g-2">
                            ...
                            <div class="col-sm-6">
                                ...
                                <span class="badge bg-secondary">🏢 Clinic Visit</span>
                            </div>
                    ...
                    <div class="alert alert-info py-3 text-start small mb-4">
                        <i class="fa fa-info-circle me-1"></i> Our medical staff will contact you shortly on <strong>{{ $booking->mobile }}</strong> to confirm your appointment timeline. You can check report updates using your booking number in the status panel.
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center">
                        ...
                        <a href="{{ route('packages.index.public') }}" class="btn btn-primary px-4 py-2">
                            🔬 View Packages
                        </a>
                    </div>
                </div>
